...
<template>
    <div class="p-2 w-full flex justify-center items-center">
        <!-- bg -->
        <div
            class="bg-gradient-to-t from-[#a9c9fb] to-[#1c66d6] rounded-2xl w-full p-5 lg:max-w-[1500px] h-auto lg:mb-0 mb-50 lg:h-[800px] flex justify-center items-center">
            ...
            <div class="flex flex-col justify-center items-center w-full">
                ...
                <div
                    ...
                    <div class="text-[24px] sm:text-[30px] font-bold text-center mt-2">เสนอหัวข้อ</div>
